...
<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
    ...
    <div class="page-header pull-right">
        <div class="page-toolbar">
            <a data-toggle="tooltip" data-placement="bottom" href="{{ route('admin.compras.index') }}" title="Volver a los registros de pedidos"  class="btn btn-blue"> <span class="fa fa-arrow-circle-o-left" aria-hidden="true"></span> Volver</a>
            @if (!$pedido->entregado)
            ...
            <div class=" col-lg-12">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel ">
                            @if (($pedido->pagado)&&($pedido->entregado))
                            @include('admin.compras.panelShowCompra')
                            @else
