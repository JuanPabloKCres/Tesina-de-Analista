<div id="modal-ingresar-cae-despues" class="modal fade" data-keyboard=”false” data-backdrop=”static”>
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="guardar_data_afip_posteriormente('{{ $pedido->id }}')">Registrar Factura</button>
            </div>
        </div>
    </div>
