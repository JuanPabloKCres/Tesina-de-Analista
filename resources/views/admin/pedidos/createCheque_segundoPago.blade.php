<div id="modal-create-cheque-2" class="modal animated fadeInLeft">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                {!! Form::open(['method' => 'POST', 'id' =>'form-crear', 'class' => 'form-horizontal']) !!}
                    <div class="form-group"><label class="col-sm-3 control-label">N° Serie</label>
                ...
                <button type="button" data-dismiss="modal" class="btn btn-white btn-block" onclick="validarFormCheque_segundoPago({{$pedido->id}})">Registrar Cheque</button>
                {!! Form::close() !!}
            </div>
        </div>
    </div>
