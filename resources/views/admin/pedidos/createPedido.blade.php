...
@section('script')
    <link type="text/css" rel="stylesheet" href="{{ asset('plantillas/KAdmin-Dark/plugins/jquery-steps-master/css/jquery.steps.css') }}  ">
    ...
    <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
        ...
        <div class="page-header pull-right">
            <div class="page-toolbar">
                ...
                <a data-toggle="tooltip" data-placement="bottom" href="javascript: confirmar()/*$('#botonMandar').click()*/" title="Registrar pedido o venta"  class="btn btn-success"> <span class="fa fa fa-plus-circle" aria-hidden="true"></span> Registrar pedido</a>
            </div>
        </div>
