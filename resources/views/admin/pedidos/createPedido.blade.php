...
<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
    ...
    <div class="page-header pull-right">
        <div class="page-toolbar">
            ...
            <a data-toggle="tooltip" data-placement="bottom" href="{{  route('admin.articulos.create') }}" title="Ir a la pantalla de confacción de articulo, util para armar prespuesto"  class="btn btn-blue"> <span class="fa fa-arrow-circle-o-left" aria-hidden="true"></span> Presupuestar Articulo</a>
