            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">
                        Apertura de nueva cuenta corriente</h4>
                </div>

                <div class="modal-body">
                    {{--
                    @include('admin.cajas.msjAbrirCC')
                    @if ($errors->any())
                    ...
                    @endif
                    --}}
    {!! Form::open(['route' => 'admin.ccorrientes.store', 'method' => 'POST', 'id' =>'form-crear', 'class' => 'form-horizontal']) !!}
                    ...
                    <div class="form-group"><label class="col-sm-3 control-label">Monto inicial</label>
                            ...
                            <button type="button" data-dismiss="modal" onclick="" class="btn btn-white btn-block">
                        Cerrar</button>                        
                    {!! Form::close() !!}
                </div>                        
            </div>
