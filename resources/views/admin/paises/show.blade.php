    ...
    <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
        ...
        <div class="page-header pull-right">
            <div class="page-toolbar">
                ...
                <a data-toggle="tooltip" data-placement="bottom" href="{{ route('admin.paises.index') }}" title="Volver a los Registros de Tipos"  class="btn btn-blue"> <span class="fa fa-arrow-circle-o-left" aria-hidden="true"></span> Volver</a>
            </div>
        </div>
