    ...
    <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
        ...
        <div class="page-header pull-right">
            <div class="page-toolbar">
                ...
                <a data-toggle="tooltip" data-placement="bottom" href="{{ route('admin.roles.index') }}" title="Volver a los Registros de Tipos"  class="btn btn-blue"> <span class="fa fa-arrow-circle-o-left" aria-hidden="true"></span> Volver</a>
            </div>
        </div>
                                                    ...
                                                    <table class="table table-striped table-hover">
                                                        <tbody> 
                                                            <tr>
                                                                ...
                                                                <td><h4>{{ $rol->nombre }}</h4></td>
                                                            </tr>
                                                            <tr>
                                                                <td><h4 class="box-heading">Fecha de alta:</h4></td>
                                                                <td><h4>{{ $rol->modulos}}</h4></td>
                                                            </tr>
                                                            <tr>
                                                                <td><h4 class="box-heading">Fecha de alta:</h4></td>
                                                                <td><h4>{{ $rol->created_at->diffForHumans() }}</h4></td>
                                                            </tr> 
                                                            <tr>
                                                                <td><h4 class="box-heading">Cantidad de usuarios con este rol:</h4></td>
                                                                <td><h4>{{ $rol->users->count() }}</h4></td>
                                                            </tr>                                                                                         
                                                        </tbody>
                                                    </table> 
                                                </div> 
