                ...
                <div class="panel-body">
                    ...
                    <table id="tab-ccorrientes" class="dataTable display table table-hover table-striped">
                        ...
                        @foreach($cuentascorrientes as $cuentacorriente)
                            <tr>
                                @if($cuentacorriente->cliente->empresa)
                                    <td class="text-center">{{ $cuentacorriente->cliente->empresa}} (responsable Sr. {{ $cuentacorriente->cliente->nombre.' '.$cuentacorriente->cliente->apellido}})</td>
                                @else
                                    <td class="text-center">{{ $cuentacorriente->cliente->nombre}} {{ $cuentacorriente->cliente->apellido}}</td>
                                @endif
                                <td class="text-center text-red">${{ $cuentacorriente->debe_cc()}}</td>
